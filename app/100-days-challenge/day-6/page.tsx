...
const Page = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-slate-950 pb-8">
      ...
      <div className="flex w-[80vw] items-center justify-center gap-4 overflow-x-auto p-2">
        {images.map((img, i) => (
