...
const Invoices = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col justify-center gap-6 bg-[#d1d3df] px-16">
      <div className="flex items-center gap-6">
        <div className="basis-1/2 rounded-xl bg-white p-4 shadow-lg">
          <h2 className="text-xl font-semibold">Balance</h2>
          <span className="text-3xl font-bold">$ {balance}</span>
        </div>
        <div className="basis-1/2 rounded-xl bg-slate-900 p-4 text-slate-50 shadow-lg">
            ...
            {invoices.map((invoice) => (
              <TableRow key={invoice.invoice}>
                ...
                <TableCell>
                  <span
                    className={clsx(
                      "rounded-full bg-opacity-50 px-3 py-1 shadow-md",
