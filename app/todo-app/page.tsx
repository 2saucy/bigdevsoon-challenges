...
const Page = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          "absolute left-1/2 top-[55%] flex h-[75vh] -translate-x-1/2 -translate-y-1/2 flex-col justify-between gap-2 rounded-lg p-2 shadow-lg shadow-slate-400/15 max-lg:w-[60vw] max-md:w-[70vw] max-sm:top-[62%] max-sm:w-full lg:w-[40vw]",
